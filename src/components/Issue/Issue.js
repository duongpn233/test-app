...
function Issue() {
    return (
        <div className='issue'>
            ...
            <img className='issue-obj1' src='/img/issue-sx1.png' alt=''></img>
            <img className='issue-obj2' src='/img/issue-sx2.png' alt=''></img>
                ...
                <div className='row no-gutters'>
                    <div className='col l-2-4 m-6 c-12 mb'>
                        <div className='issue-banner'>
                            <div className='issue-banner-content'>
                                ...
                                <img className='issue-banner-img' src='/img/issue-r.png' alt=''></img>
                            </div>
                            <img className='issue-banner-icon' src='/img/issue-icon.png' alt=''></img>
                        </div>
                    </div>
                    <div className='col l-2-4 m-6 c-12'>
                        <div className='issue-item hot'>
                            <div className='issue-item-brand'>B BRAND</div>
                            <div className='issue-item-img' style={{ backgroundImage: 'url(/img/issue-item.png)' }}></div>
                            <img className='issue-item-icon-hot' src='/img/issue-hot.png' alt=''></img>
                        </div>
                    </div>
                    <div className='col l-2-4 m-6 c-12'>
                    ...
                    <div className='col l-2-4 m-6 c-12'>
                        <div className='issue-item icon'>
                            <div className='issue-item-brand'>B BRAND</div>
                            <div className='issue-item-img' style={{ backgroundImage: 'url(/img/issue-item.png)' }}></div>
                            <img className='issue-item-icon-lol' src='/img/issue-lol.png' alt=''></img>
                        </div>
                    </div>
                </div>
            </div>
