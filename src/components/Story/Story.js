        ...
        <div className='story'>
            ...
            <div className='story-container'>
                <div className='story-bgr'>
                    <img className='story-bgr-img' src='/test-app/img/story-bgr.png' alt=''></img>
                </div>
                ...
                <img className='story-content-obj1' src='/test-app/img/obj1.png' alt=''></img>
                <img className='story-content-obj2' src='/test-app/img/obj2.png' alt=''></img>
                <img className='story-content-obj3' src='/test-app/img/obj3.png' alt=''></img>
                <img className='story-content-obj4' src='/test-app/img/obj4.png' alt=''></img>
                <img className='story-content-obj5' src='/test-app/img/obj5.png' alt=''></img>
                <img className='story-content-obj6' src='/test-app/img/obj6.png' alt=''></img>
                <img className='story-content-obj7' src='/test-app/img/obj7.png' alt=''></img>
            </div>
        </div>
    )
}
